...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                @if($movie['poster'])
                    <img src="{{$movie['poster']}}" alt="actor1" class="w-64 lg:w-96">
                @else
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        ...
                        <div class="mr-8">
                            <div> Rent Start</div>
                            <div class="text-sm text-gray-400">
                                {{\Carbon\Carbon::parse($movie['rent_start'])->format('Y-m-d')}}
                            </div>
                        </div>
                        <div class="mr-8">
                            <div> Rent End</div>
                            <div class="text-sm text-gray-400">
                                {{\Carbon\Carbon::parse($movie['rent_end'])->format('Y-m-d')}}
                            </div>
                        </div>
...
{{--                    @if (count($movie['videos']['results']) > 0)--}}
                        <div class="mt-12">
                            <form action="{{route('movies.rent')}}" method="post">
                                @csrf
                                ...
                                @if(!$rented)
                                    ...
                                    >
                                        ...
                                        <span class="ml-2">Rent Movie</span>
                                    </button>
                            @endif
                            </form>
                            @if($rented)
                            ...
                            <a
                                ...
                                class="flex mt-5 inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-red-600 transition ease-in-out duration-150"
                            >
                                <svg class="w-6 fill-current " viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
...
{{--                    <a href="#">--}}
{{--                        @if($movie->cast['names'])--}}
{{--                            <img src="{{'https://image.tmdb.org/t/p/w300/'.$movie->cast['names']}}" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">--}}
{{--                        @else--}}
{{--                            <img src="https://via.placeholder.com/300x450" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">--}}
{{--                        @endif--}}
{{--                    </a>--}}
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">{{ $movie->cast['names'] }}</a>
                        <div class="text-sm text-gray-400">
                            {{ $movie->cast['namces'] }}
                        </div>
                    </div>
